# ============================================================================
# Finite Group: Symmetric Group Sₙ - Permutation Matrices
# ============================================================================
#
# Permutation matrices represent elements of the symmetric group Sₙ. Since
# permutations have finite order (Pᵏ = I for some k), eigenvalues must be
# roots of unity satisfying λᵏ = 1.
#
# The cycle structure of a permutation determines its eigenvalues:
# - A k-cycle contributes the k-th roots of unity: {1, ω, ω², ..., ωᵏ⁻¹}
#   where ω = exp(2πi/k)
# - Multiple cycles contribute independently
#
# This gives closed-form eigenvalues for any permutation matrix.
# ============================================================================
